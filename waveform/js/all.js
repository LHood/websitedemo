...
! function(t, n) {
    ...
    t.fn.noUiSlider = function(e) {
        function a(n, e, a) { t.isArray(n) || (n = [n]), t.each(n, function(t, n) { "function" == typeof n && n.call(e, a) }) }

        function i(n) { return n instanceof t || t.zepto && t.zepto.isZ(n) }

        function o(e) {
            e.preventDefault();
            var a, i, o = 0 === e.type.indexOf("touch"),
        ...
        function r(n, e, a, i, r) { return n = n.replace(/\s/g, x + " ") + x, r ? (r > 1 && (i = t.extend(e, i)), e.on(n, t.proxy(a, i))) : (i.handler = a, e.on(n, t.proxy(function(t) { return this.target.is('[class*="noUi-state-"], [disabled]') ? !1 : void this.handler(o(t)) }, i))) }

        function s(t) { return !isNaN(parseFloat(t)) && isFinite(t) }

        function l(t) { return parseFloat(this.style[t]) }

        function d(n, e) {
            function a(t) { return i(t) || "string" == typeof t || t === !1 }
            var o = {
                    handles: { r: !0, t: function(t) { return t = parseInt(t, 10), 1 === t || 2 === t } },
                    range: { r: !0, t: function(t, n, e) { return 2 !== t.length ? !1 : (t = [parseFloat(t[0]), parseFloat(t[1])], s(t[0]) && s(t[1]) ? "range" === e && t[0] === t[1] ? !1 : t[1] < t[0] ? !1 : (n[e] = t, !0) : !1) } },
                    start: { r: !0, t: function(n, e, a) { return 1 === e.handles ? (t.isArray(n) && (n = n[0]), n = parseFloat(n), e.start = [n], s(n)) : this.parent.range.t(n, e, a) } },
                    connect: { t: function(t, n) { return t === !0 || t === !1 || "lower" === t && 1 === n.handles || "upper" === t && 1 === n.handles } },
                    orientation: { t: function(t) { return "horizontal" === t || "vertical" === t } },
                    margin: { r: !0, t: function(t, n, e) { return t = parseFloat(t), n[e] = t, s(t) } },
                    serialization: {
                        r: !0,
                        t: function(n, e) {
                    ...
                    slide: { t: function(t) { return "function" == typeof t } },
                    set: { t: function(t, n) { return this.parent.slide.t(t, n) } },
                    step: { t: function(t, n, e) { return this.parent.margin.t(t, n, e) } },
                    init: function() { var n = this; return t.each(n, function(t, e) { e.parent = n }), delete this.init, this }
                },
                r = o.init();
            t.each(r, function(t, a) { if (a.r && !n[t] && 0 !== n[t] || (n[t] || 0 === n[t]) && !a.t(n[t], n, t)) throw console && console.log && console.group && (console.group("Invalid noUiSlider initialisation:"), console.log("Option:	", t), console.log("Value:	", n[t]), console.log("Slider:	", e[0]), console.groupEnd()), new RangeError("noUiSlider") })
        }

        function u(t, n) { return Math.round(t / n) * n }

        function c(t, n) { return t = t.toFixed(n.data("decimals")), t.replace(".", n.data("mark")) }

        function h(t, n, e) {
            var a, i = t.data("nui").options,
        ...
        function f(e, a) {
            ...
            return i(a.to[o]) ? (r("change blur", a.to[o], O[0], s, 2), r("change", a.to[o], s.options.set, s.target, 1), a.to[o]) : "string" == typeof a.to[o] ? t('<input type="hidden" name="' + a.to[o] + '">').appendTo(e).addClass(C[3]).change(O[1]) : a.to[o] === !1 ? { val: function(t) { return t === n ? this.handleElement.data("nui-val") : void this.handleElement.data("nui-val", t) }, hasClass: function() { return !1 }, handleElement: e } : void 0
        }
        ...
        function v(n) {
            ...
            e.children().addClass(C[4]), r(P.move, E, p, { startEvent: n, position: a, base: this.base, target: this.target, handle: e }), r(P.end, E, g, { base: this.base, target: this.target, handle: e }), t("body").on("selectstart" + x, function() { return !1 })
        }

        function m(t) { t.stopPropagation(), g.call(this) }

        function b(t) {
            if (!this.base.find("." + C[4]).length) {
                var n, e, i, o = this.base,
                    r = this.handles,
                    s = o.data("style"),
                    l = t["left" === s ? "x" : "y"],
                ...
                i = 1 === r.length ? 0 : (u.handles[0][s] + u.handles[1][s]) / 2, e = 1 === r.length || i > l ? r[0] : r[1], o.addClass(C[5]), setTimeout(function() { o.removeClass(C[5]) }, 300), h(e, 100 * (l - u.base[s]) / d), a([e.data("nui").options.slide, e.data("nui").options.set], o.data("target")), o.data("target").change()
            }
        }
        ...
        function U(e, i) {
            return e === n ? w.call(this) : (i = i === !0 ? { trigger: !0 } : i || {}, t.isArray(e) || (e = [e]), this.each(function(o, r) {
                r = t(r), t.each(t(this).data("handles"), function(o, s) {
                    if (null !== e[o] && e[o] !== n) {
                        var l, d, u, f = s.data("nui").options.range,
                            p = e[o];
        ...
        var x = ".nui",
            E = t(document),
            P = { start: "mousedown touchstart", move: "mousemove touchmove", end: "mouseup touchend" },
            z = t.fn.val,
            ...
            k = { to: function(t, n) { return n = t[0] < 0 ? n + Math.abs(t[0]) : n - t[0], 100 * n / this.len(t) }, from: function(t, n) { return 100 * n / this.len(t) }, is: function(t, n) { return n * this.len(t) / 100 + t[0] }, len: function(t) { return t[0] > t[1] ? t[0] - t[1] : t[1] - t[0] } },
            O = [function() { this.target.val([this.i ? null : this.val(), this.i ? this.val() : null], { trusted: !1 }) }, function(t) { t.stopPropagation() }];
        return window.navigator.pointerEnabled ? P = { start: "pointerdown", move: "pointermove", end: "pointerup" } : window.navigator.msPointerEnabled && (P = { start: "MSPointerDown", move: "MSPointerMove", end: "MSPointerUp" }), t.fn.val = function() { return this.hasClass(C[6]) ? U.apply(this, arguments) : z.apply(this, arguments) }, y.call(this, e)
    }
}($);
(function() {
    var lastTime = 0;
...
$(document).ready(function() {
    ...
    if ($("#codepen-script").length) {
        ...
        var form =
            '<div class="interface clearfix"><button title="CodePen is a free online tool for editing and writing code." onclick=\'document.getElementById("codepen-form").submit();\'><i class="icon-link-ext"></i> Open with CodePen <i class="fa fa-codepen"></i></button></div>' +
